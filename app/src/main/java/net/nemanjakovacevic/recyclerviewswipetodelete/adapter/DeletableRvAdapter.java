...
public class DeletableRvAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new DeletableViewHolder(parent);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        DeletableViewHolder viewHolder = (DeletableViewHolder) holder;
     ...
     */
    static class DeletableViewHolder extends RecyclerView.ViewHolder {

        TextView titleTextView;
        Button undoButton;

        public DeletableViewHolder(ViewGroup parent) {
